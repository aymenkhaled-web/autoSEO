  ...
  return (
    ...
    >
      ...
      <div className="fixed inset-0 overflow-hidden pointer-events-none">
        <div
          className="absolute -top-40 -left-40 w-96 h-96 rounded-full blur-[128px] opacity-20"
          style={{ background: 'var(--color-brand)' }}
        />
        <div
          className="absolute -bottom-40 -right-40 w-96 h-96 rounded-full blur-[128px] opacity-10"
      ...
      >
        ...
        >
          ...
          <p className="mb-6" style={{ color: 'var(--color-text-secondary)' }}>
            Sign in to your AutoSEO dashboard
          </p>
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <button
              ...
              style={{
                background: loading ? 'var(--color-brand-dark)' : 'var(--color-brand)',
